...
export default function DiplomaView() {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      link.href     = url;
      link.download = `${normalizedCode}.pdf`;
  ...
  // ── Vista del diploma (tras verificación exitosa) ───────────────────────────
  return (
        ...
        <div className="p-8 md:p-14 flex flex-col">
          ...
          <div className="flex items-start justify-between mb-10">
            ...
            <div className="text-right">
              ...
              <p className="text-uprit-gray font-mono font-bold text-sm tracking-wider">{normalizedCode}</p>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <div className="grid grid-cols-2 gap-4 w-full max-w-xs mb-10">
              <div className="border border-gray-200 rounded-lg p-4 text-center">
                ...
                <p className="font-mono font-bold text-uprit-gray text-sm">{normalizedCode}</p>
              </div>
              <div className="border border-gray-200 rounded-lg p-4 text-center">
